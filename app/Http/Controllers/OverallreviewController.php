...
class OverallreviewController extends Controller
{
    /**
    ...
    public function index(Request $request,$page = 1)
    {
        ...
        $overallreview = $response['data'];
        $pagination = $response['meta']['pagination'];

        $lastpage = $pagination['total_pages'];
        

          return view('overall_review_list', compact('overallreview', 'pagination','lastpage'));
    }
    ...
    public function show($id)
    {
        ...
        try{
            ...
            $call = Http::withToken($token)->withHeaders(['Accept'=>'application/vnd.api.v1+json','Content-Type'=>'application/json'])->get(config('global.url') . '/api/getPropertyRelations/'.$id.'?include=OaReview,Reviews');
