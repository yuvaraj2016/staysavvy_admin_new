        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form class="dropzone" action="{{route('centralsystem.update',['centralsystem'=>$centralsystem['id']]) }}" method="post" id="editstatus"
...
<option value="{{ $status['id'] }}" {{ ($centralsystem['status_id'] == $status['id']) ? "selected":(old("status_id") == $status['id'] ? "selected":"") }}>{{ $status['status_desc'] }}</option>
@endforeach
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7 offset-5">
                                    ...
                                    <a href="{{ url('central_system_list') }}"
