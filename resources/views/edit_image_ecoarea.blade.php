            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('ecoarea.index') }}">Ecoarea</a>
                        </li>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4 offset-1">
                                            <label class="col-form-label text-md-right ">Ecoarea Desc</label>
                                            <b>{{ $editdata['highlight_desc'] }}</b>
                            ...
                            <div class="form-group row mb-5">
                                ...
                                <div class="col-sm-12 col-md-7 offset-5">
                                        ...
                                        <a href="{{ url('ecoarea/'.$editdata['id'].'/edit') }}"
