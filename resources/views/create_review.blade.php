    ...
    <div class="section-body">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('review.store') }}" class="swa-confirm"  method="post" id="addstatus"
                            ...
                            <div class="col-sm-4">
                                <label class="col-form-label text-md-right c">Total Credits</label>
                                
                                    <input type="number" min="0" step="any" name="total_credits" class="summernote-simple form-control" value="{{ old('total_credits') }}" required>
