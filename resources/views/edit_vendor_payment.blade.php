                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        <li class="breadcrumb-item">
                                ...
                                <p class="">Edit Vendor Payment</p>
                          
                        </li>
                      
                        <li class="breadcrumb-item"><a href="{{  url()->previous()  }}">Vendor Payment</a>
                        </li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form class="dropzone" action="{{route('vendor_payment.update',['venpay'=>$venpay['id']]) }}" method="post" id="editstatus"
                        ...
                        @endif
                                        ...
                                        @foreach($paymentstatus as $paymentsts)
                                            <option value="{{ $paymentsts['id'] }}" {{ ($venpay['payment_status_id'] == $paymentsts['id']) ? "selected":(old("payment_status_id") == $paymentsts['id'] ? "selected":"") }}>{{ $paymentsts['title'] }}</option>
                                            @endforeach
                                    </select>
                                                        </div>
