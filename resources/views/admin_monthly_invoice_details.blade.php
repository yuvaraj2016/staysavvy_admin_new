                                ...
                                {{-- @dd($prodcategories) --}}
                                    ...
                                    {{-- <td>
                                       ...
                                       <td>
                                        ...
                                        <td>
                                        {{$invoice['UserInvoice']['data']['commission_percentage']}}
                                        </td>
                                        <td>
                                        {{$invoice['UserInvoice']['data']['commission_amount']}}
                                        </td>
                                        <td>
                                        {{$invoice['UserInvoice']['data']['total_amount']}}
                                        </td>
                                        <td>
                                        {{$invoice['UserInvoice']['data']['user_name']}}
                                        </td>
                                        <!-- <td>
