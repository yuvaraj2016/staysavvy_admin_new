                ...
                <div class="card">
                    ...
                    <div class="card-header table-card-header">
                        <div class="row">
                            ...
                            @if(collect(session('permissions'))->contains('Create config status'))
...
@endif
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <ul class="list-group list-inline ml-1">
                                                    ...
                                                    <a href="{{ url('status/'.$id) }}" class=" d-inline font1 view-confirmation" id="alert1" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-eye"></i></a>
                                                @endif
                                                </li>
                                                    ...
                                                    <li class="list-group-item border1">
                                                    @if(collect(session('permissions'))->contains('Update config status'))
                                                    <a href="{{ url('status/'.$id.'/edit') }}"  class=" d-inline font1 edit-confirmation" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></a>
                                                @endif
                                                </li>
                                                    <!-- <li class="list-group-item border1">
    ...
    @if(collect(session('permissions'))->contains('Delete config status'))
