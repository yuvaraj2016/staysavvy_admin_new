    ...
    <div class="section-body">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('ecoarea.store') }}" class="swa-confirm"  method="post" id="addstatus"
...
sam@staysavvy.net if they believe something else should be mentioned or something should be edited.</address>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7 offset-5">
                                    <button type="submit" id="submit" class="btn btn-primary">Create Property To Ecoarea</button>
                                </div>
                            </div>
