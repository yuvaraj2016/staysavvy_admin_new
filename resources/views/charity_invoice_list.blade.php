                        ...
                        <div class="row">
                            ...
                            <div class="section-header-button col-md-3 ">
                                ...
                                <ul id="pagination" class="float-right m-0 p-0">
                                        <li><a href="{{ route('charity.invoice',$page=1) }}" class="btn btn-primary @if($pagination['current_page']==1) {{ "disabled" }} @endif">First</a></li>
                                        @php
                                        ...
                                        @endphp
                                        <li><a href="{{ route('charity.invoice',$page) }}" class="btn btn-primary">Previous</a></li>
                                        @php
                                        }
                                        @endphp
                                        ...
                                        // echo
                                        @endphp
                                        <li> <a href="{{ route('charity.invoice',$page) }}" class="btn btn-primary">Next</a></li>
                                        @php
                                        }
                                        ...
                                        {
                                        @endphp
                                        <li> <a href="{{ route('charity.invoice',$pagination['total_pages']) }}" class="btn btn-primary float-right">Last</a> </li>
