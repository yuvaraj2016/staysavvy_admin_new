                ...
                <div class="card">
                    ...
                    <div class="card-header table-card-header">
                        <div class="row">
                            ...
                            <!-- @if(collect(session('permissions'))->contains('Create tax')) -->
                                <a href="{{ route('highlight.create') }}" id="alert" class="btn btn-primary" style="box-shadow: 0 2px 6px #acb5f6;
...
<!-- @endif -->
                            ...
                            <div class="section-header-button col-md-3 ">
                                ...
                                <ul id="pagination" class="float-right m-0 p-0">
                                        <li><a href="{{ route('highlight.index',$page=1) }}" class="btn btn-primary @if($pagination['current_page']==1) {{ "disabled" }} @endif">First</a></li>
                                        @php
                                        ...
                                        @endphp
                                        <li><a href="{{ route('highlight.index',$page) }}" class="btn btn-primary">Previous</a></li>
                                        @php
                                        }
                                        @endphp
                                        ...
                                        // echo
                                        @endphp
                                        <li> <a href="{{ route('highlight.index',$page) }}" class="btn btn-primary">Next</a></li>
                                        @php
                                        }
                                        ...
                                        {
                                        @endphp
                                        <li> <a href="{{ route('highlight.index',$pagination['total_pages']) }}" class="btn btn-primary float-right">Last</a> </li>
                                    ...
                                    <td>
                                            <div class="d-flex">
                                                ...
                                                <!-- </li> -->
                                                    ...
                                                    <a href="{{ url('highlight/'.$id.'/edit') }}"  class=" d-inline font1 edit-confirmation" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></a>
                                                <!-- @endif -->
                                                </li>
                                             

                                                    <li class="list-group-item border1">
                                                    <form id="delete_from_{{$Highlights['id']}}" method="POST" action="{{route('highlight.destroy', $Highlights['id']) }}">
                    {{ csrf_field() }}
    {{ method_field('DELETE') }}

    <div class="form-group">
    <!-- @if(collect(session('permissions'))->contains('Delete tax')) -->
        <a href="javascript:void(0);" data-id="{{$Highlights['id']}}" class="_delete_data"  data-toggle="tooltip" data-placement="top" title="Delete" style="background-color:#fff!important;position: relative;top:-1px!important; padding-top:3px!important;padding-bottom:8px!important;">
