        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form class="dropzone" action="{{route('property.update',['property'=>$property['id']]) }}" method="post" id="editstatus"
                        ...
                        @endif
                                                    ...
                                                    <div class="col-sm-4">
                                                        <label class="col-form-label text-md-right">Property Name</label>
                                                            ...
                                                            <input value="{{ old('name',$property['name']) }}" name="name" class="summernote-simple form-control" required>
                                                        </div>

                                                    <div class="col-sm-4">
                                                        <label class="col-form-label text-md-right">Property Desc</label>
                                                      
                                                            <textarea name="description" class="summernote-simple form-control" required>{{ old('description',$property['description']) }}</textarea>
                                                        </div>
                                                        <div class="col-sm-4">
...
<option value="{{ $status['id'] }}" {{ ($property['status_id'] == $status['id']) ? "selected":(old("status_id") == $status['id'] ? "selected":"") }}>{{ $status['status_desc'] }}</option>
@endforeach
