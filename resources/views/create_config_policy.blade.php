                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        <li class="breadcrumb-item">
                                ...
                                <p class="">Create  Config Policy</p>
    ...
    <div class="section-body">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('config_policies.store') }}" class="swa-confirm"  method="post" id="addstatus"
                            ...
                            <div class="col-sm-4 offset-2">
                                <label class="col-form-label text-md-right c">Policy Name</label>
                            ...
                            <div class="col-sm-4">
                                                        ...
                                                        <select  class="js-example-basic-single col-sm-12" name="status_id" id=""   class="form-control selectric" required>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7 offset-5">
                                    <button type="submit" id="submit" class="btn btn-primary">Create Policy</button>
                                </div>
                            </div>
