            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('vendor.invoice') }}">Vendor Invoice List</a>
                        </li>
                        ...
                        <div class="row">
                            ...
                            <div class="section-header-button col-md-3 ">
                                ...
                                <ul id="pagination" class="float-right m-0 p-0">
                                        <li><a href="{{ route('vendor.invoice',$page=1) }}" class="btn btn-primary @if($pagination['current_page']==1) {{ "disabled" }} @endif">First</a></li>
                                        @php
                                        ...
                                        @endphp
                                        <li><a href="{{ route('vendor.invoice',$page) }}" class="btn btn-primary">Previous</a></li>
                                        @php
                                        }
                                        @endphp
                                        ...
                                        // echo
                                        @endphp
                                        <li> <a href="{{ route('vendor.invoice',$page) }}" class="btn btn-primary">Next</a></li>
                                        @php
                                        }
                                        ...
                                        {
                                        @endphp
                                        <li> <a href="{{ route('vendor.invoice',$pagination['total_pages']) }}" class="btn btn-primary float-right">Last</a> </li>
                                    ...
                                    <td>
                                            <div class="d-flex">
                                                <ul class="list-group list-inline ml-1">
                                                    ...
                                                    <a href="#" class=" d-inline font1 " id="alert1" data-toggle="tooltip" data-placement="top" title="View Invoices" style="font-size:14px!important;"><i class="fa fa-eye"></i>&nbsp;&nbsp;&nbsp;View Invoices</a>
                                                {{-- @endif --}}
                                                </li>
