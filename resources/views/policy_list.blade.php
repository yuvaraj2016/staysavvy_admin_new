            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('policies.index') }}">Policy List</a>
                        </li>
                    ...
                    @endif
                            ...
                            <div class="section-header-button col-md-3 ">
                                ...
                                <ul id="pagination" class="float-right m-0 p-0">
                                        <li><a href="{{ route('policies.index',$page=1) }}" class="btn btn-primary @if($pagination['current_page']==1) {{ "disabled" }} @endif">First</a></li>
                                        @php
                                        ...
                                        @endphp
                                        <li><a href="{{ route('policies.index',$page) }}" class="btn btn-primary">Previous</a></li>
                                        @php
                                        }
                                        @endphp
                                        ...
                                        // echo
                                        @endphp
                                        <li> <a href="{{ route('policies.index',$page) }}" class="btn btn-primary">Next</a></li>
                                        @php
                                        }
                                        ...
                                        {
                                        @endphp
                                        <li> <a href="{{ route('policies.index',$pagination['total_pages']) }}" class="btn btn-primary float-right">Last</a> </li>
                            ...
                            <table id="basic-btn" class="table table-striped table-bordered nowrap">
                                ...
                                {{-- @dd($prodcategories) --}}
                                    ...
                                    <td>
                                        ...
                                        <td>{{ date("Y-m-d H:i:s",$policys['created_at']) }}</td>
                                        <td>
                                            <div class="d-flex">
                                                <ul class="list-group list-inline ml-1">
                                                    <li class="list-group-item border1">
                                                    @if(collect(session('permissions'))->contains('List policy'))
                                                    <a href="{{ url('policies/'.$id) }}" class=" d-inline font1 " id="alert1" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-eye"></i></a>
                                                @endif
                                                </li>
                                                    ...
                                                    <li class="list-group-item border1">
                                                    @if(collect(session('permissions'))->contains('Update policy'))
                                                    <a href="{{ url('policies/'.$id.'/edit') }}"  class=" d-inline font1 edit-confirmation" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></a>
                                                @endif
                                                </li>
                                           

                                                    <li class="list-group-item border1">
                                                    <form id="delete_from_{{$policys['id']}}" method="POST" action="{{route('policies.destroy', $policys['id']) }}">
                    {{ csrf_field() }}
    {{ method_field('DELETE') }}

    <div class="form-group">
    @if(collect(session('permissions'))->contains('Delete policy'))
        <a href="javascript:void(0);" data-id="{{$policys['id']}}" class="_delete_data"  data-toggle="tooltip" data-placement="top" title="Delete" style="background-color:#fff!important;position: relative;top:-1px!important; padding-top:3px!important;padding-bottom:8px!important;">
