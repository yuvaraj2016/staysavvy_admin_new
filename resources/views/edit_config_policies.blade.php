            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="dropzone" action="{{route('config_policies.update',['config_policy'=>$policies['id']]) }}" method="post" id="editstatus"
                        ...
                        @endif
                                                    ...
                                                    <div class="col-sm-4 offset-2">
                                                        <label class="col-form-label text-md-right">name</label>
                                                            ...
                                                            <input  name="name" value="{{ old('from',$policies['name']) }}" class="summernote-simple form-control" required>
                                                        </div>
...
<option value="{{ $statusess['id'] }}" {{ ($policies['status_id'] == $statusess['id']) ? "selected":(old("status_id") == $statusess['id'] ? "selected":"") }}>{{ $statusess['status_desc'] }}</option>
@endforeach
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7 offset-5">
                                    ...
                                    <a href="{{ url('config_policies_list') }}"
