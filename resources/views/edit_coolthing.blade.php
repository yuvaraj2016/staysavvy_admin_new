                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        <li class="breadcrumb-item">
                                ...
                                <p class="">Edit Coolthing</p>
                          
                        </li>
                      
                        <li class="breadcrumb-item"><a href="{{ route('coolthing.index') }}">Coolthing</a>
                        </li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form class="dropzone" action="{{route('coolthing.update',['coolthing'=>$coolthing['id']]) }}" method="post" id="editstatus"
                        ...
                        @endif
                                                    ...
                                                    <div class="col-sm-4">
                                                        <label class="col-form-label text-md-right">coolthing Name</label>
                                                            ...
                                                            <input value="{{ old('name',$coolthing['name']) }}" name="name" class="summernote-simple form-control" required>
                                                        </div>
...
<option value="{{ $status['id'] }}" {{ ($coolthing['status_id'] == $status['id']) ? "selected":(old("status_id") == $status['id'] ? "selected":"") }}>{{ $status['status_desc'] }}</option>
@endforeach
