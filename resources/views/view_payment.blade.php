                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('payment.store') }}" method="post" id="addstatus"
                            ...
                            <div class="col-sm-4 ">
                                                        <label class="col-form-label text-md-right ">Payment Title</label>
                                                        <input type="text"  value="   {{ $payment['title'] }}" class="form-control" readonly>
                                                        </div>
                                                        <div class="col-sm-4 ">
                                                        <label class="col-form-label text-md-right ">Payment Status Desc</label>
                                                        <input type="text"  value="   {{ $payment['payment_status_desc'] }}" class="form-control" readonly>
                                                        </div>
                                                        <div class="col-sm-4 ">
                                                        <label class="col-form-label text-md-right ">Created At </label>
                                                        <input type="text"  value="    {{ date("Y-m-d H:i:s",$payment['created_at']) }}" class="form-control" readonly>
