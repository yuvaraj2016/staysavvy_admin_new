        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form class="dropzone" action="{{route('booksts.update',['bookst'=>$bookst['id']]) }}" method="post" id="editstatus"
                        ...
                        @endif
                                                    ...
                                                    <div class="col-sm-4 offset-1">
                                                        <label class="col-form-label text-md-right">Booking Status Title</label>
                                                            ...
                                                            <input value="{{ old('title',$bookst['title']) }}" name="title" class="summernote-simple form-control" required>
                                                        </div>

                                                    <div class="col-sm-4 offset-1">
                                                        <label class="col-form-label text-md-right">Status Desc</label>
                                                      
                                                            <textarea name="description" class="summernote-simple form-control" required>{{ old('description',$bookst['description']) }}</textarea>
                                                        </div>
                                                    </div>
