    ...
    <div class="section-body">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('tax.store') }}" class="swa-confirm"  method="post" id="addstatus"
                            ...
                            <div class="col-sm-4">
                                <label class="col-form-label text-md-right c">Tax Percentage</label>
                                
                                    <input type="number" min="0" step="any" name="percentage" class="summernote-simple form-control" value="{{ old('percentage') }}" required>
                               
                            </div>

                            <div class="col-sm-4">
                                <label class="col-form-label text-md-right c">Tax Amount</label>
                                
                                    <input type="number" min="0" step="any" name="amount"  class="summernote-simple form-control" value="{{ old('amount') }}" required>
