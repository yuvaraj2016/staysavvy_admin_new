...
@if(count($chart['labels']) <= 0 && count($chart['datasets']) <= 0)
...
@else
 ...
 @endif    
                          ...
                          <label class="col-form-label text-md-right c">Arrivals</label>
                                ...
                                <p name="name" >{{$bookingobverview['arrivals_count']}}</p>
                          ...
                          <label class="col-form-label text-md-right c">Departures</label>
                                ...
                                <p name="name" >{{$bookingobverview['departures_count']}} </p>
                          ...
                          <label class="col-form-label text-md-right c">New Bookings</label>
                                ...
                                <p name="name" > {{$bookingobverview['new_booking_count']}}</p>
