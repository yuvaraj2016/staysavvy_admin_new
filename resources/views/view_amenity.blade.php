    ...
    <div class="section-body">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('amenity.store') }}" method="post" id="addstatus"
                            ...
                            <div class="col-sm-4 ">
                                                        ...
                                                        <input type="text"  value="   {{ $amenity['name'] }}" class="form-control" readonly>
                                                        </div>
                                                        <div class="col-sm-4 ">
                                                        <label class="col-form-label text-md-right ">Location</label>
                                                        <input type="text"  value="   {{ $amenity['location'] }}" class="form-control" readonly>
                                                        </div>
                                                        
                                                        <div class="col-sm-4 ">
                                                        <label class="col-form-label text-md-right ">Status</label>
                                                        <input type="text"  value="   {{ $amenity['status_desc'] }}" class="form-control" readonly>
                                                        </div>
                                                    </div>
                            ...
                            <input type="text"  value="    {{ date("Y-m-d H:i:s",$amenity['created_at']) }}" class="form-control" readonly>
