        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    <div class="d-inline">
                        <h4>Edit Charity Settlement Payment</h4>
            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <a href="{{  url()->previous()  }}">Charity Settlement Payment</a>
                                <!-- <p class="">Edit Charity Settlement Payment</p> -->
                          
                        </li>
                      
                        <!-- <li class="breadcrumb-item"><a href="{{  url()->previous()  }}">Charity Settlement Payment</a>
                        </li> -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form class="dropzone" action="{{route('charityset_payment.update',['charitypay'=>$charitypay['id']]) }}" method="post" id="editstatus"
                        ...
                        @endif
                                        ...
                                        @foreach($paymentstatus as $paymentsts)
                                            <option value="{{ $paymentsts['id'] }}" {{ ($charitypay['payment_status_id'] == $paymentsts['id']) ? "selected":(old("payment_status_id") == $paymentsts['id'] ? "selected":"") }}>{{ $paymentsts['title'] }}</option>
                                            @endforeach
                                    </select>
                                                        </div>
