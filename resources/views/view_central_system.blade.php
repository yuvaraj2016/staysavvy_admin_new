    ...
    <div class="section-body">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('centralsystem.store') }}" method="post" id="addstatus"
                            ...
                            <input type="text"  value="   {{ $centralsystem['status_desc'] }}" class="form-control" readonly>
                            </div>
                                                    </div>
                            ...
                            <input type="text"  value="    {{ date("Y-m-d H:i:s",$centralsystem['created_at']) }}" class="form-control" readonly>
