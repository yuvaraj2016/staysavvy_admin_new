                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <ul class="list-group list-inline ml-1">
                                                    ...
                                                    <a href="{{ url('coolthings/'.$id) }}" class=" d-inline font1 " id="alert1" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-eye"></i></a>
                                                @endif
                                                </li>
                                                    ...
                                                    <a href="{{ url('coolthings/'.$id.'/edit') }}"  class=" d-inline font1 edit-confirmation" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></a>
                                                @endif
                                                </li>
